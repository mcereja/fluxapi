package mcereja.fluxapi.functional;
...
/*
 * Usando com estilo funcional de programacao para os end-points
 * OBS. TEM QUE COMENTAR O @RestController da PlaylistController
 *
 */
